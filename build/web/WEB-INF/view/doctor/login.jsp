<%-- 
    Document   : login
    Created on : Apr 10, 2019, 4:09:57 PM
    Author     : sakib
--%>
                                                ...
                                                <div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
                                                    ...
                                                    <div class="panel panel-skin">
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <form action="doctor-login" method="post" role="form" class="contactForm lead">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="username" id="email" class="form-control input-md" data-rule="email" data-msg="Please enter a valid email">
                                                                    ...
                                                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="password" name="password" id="phone" class="form-control input-md" data-rule="required" data-msg="The phone number is required">
                                                                            <div class="validation"></div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <p class="text-center">Don't have an account? <a class="text-info" href="doctor-register"> Sign Up </a> !</p>
                                                        </div>
                                                    </div>
