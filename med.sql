...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 10, 2019 at 10:22 PM
...
INSERT INTO `appointment` (`id`, `visiting_date`, `serial`, `name`, `contact_num`, `patient_id`, `doctor_id`) VALUES
(7, '2019/04/10', 1, 'samsung', '01715', 10, 1),
(8, '2019/04/10', 2, 'samsung', '01715', 10, 1),
(9, '2019/04/10', 3, 'samsung', '01715', 10, 1),
(10, '2019/04/10', 1, 'fadsd', '01715', 10, 4),
(11, '2019/04/10', 1, 'sakib', '1', 10, 6),
(12, '2019/04/10', 2, 'sakib', '1', 10, 6),
(13, '2019/04/11', 1, 'sakib', '01715', 10, 7),
(14, '2019/04/11', 2, 'samsung', '01715', 1, 7),
(15, '2019/04/11', 1, 'samsung', '01715', 1, 6),
(16, '2019/04/11', 1, 'sakib12', '01715', 1, 1),
(17, '2019/04/11', 2, 'sakib13', '01715', 1, 1);
...
CREATE TABLE `dataset` (
  `Pregnancies` decimal(11,0) DEFAULT NULL,
  `Glucose` decimal(11,0) DEFAULT NULL,
  `BloodPressure` decimal(11,0) DEFAULT NULL,
  `SkinThickness` decimal(11,0) DEFAULT NULL,
  `Insulin` decimal(11,0) DEFAULT NULL,
  `BMI` decimal(10,1) DEFAULT NULL,
  `DiabetesPedigreeFunction` decimal(6,3) DEFAULT NULL,
  `Age` decimal(11,0) DEFAULT NULL,
  `Outcome` decimal(11,0) DEFAULT NULL
...
INSERT INTO `dataset` (`Pregnancies`, `Glucose`, `BloodPressure`, `SkinThickness`, `Insulin`, `BMI`, `DiabetesPedigreeFunction`, `Age`, `Outcome`) VALUES
...
('7', '195', '70', '33', '145', '25.1', '0.163', '55', '1'),
('6', '154', '74', '32', '193', '29.3', '0.839', '39', '0'),
('0', '136', '74', '49', '220', '20.1', '0.820', '44', '1'),
('0', '126', '84', '29', '215', '30.7', '0.520', '24', '0'),
('0', '116', '64', '39', '225', '40.2', '0.720', '50', '0'),
('2', '142', '94', '59', '177', '38.3', '0.620', '63', '1'),
('4', '183', '66', '0', '215', '80.6', '0.654', '40', '0'),
('1', '100', '62', '0', '0', '64.4', '0.152', '36', '0'),
('0', '163', '40', '23', '64', '40.7', '0.322', '33', '0'),
('6', '139', '84', '37', '0', '50.7', '0.320', '50', '1'),
('2', '167', '44', '30', '140', '52.7', '0.452', '28', '0'),
('3', '162', '0', '110', '215', '48.7', '0.520', '24', '0'),
('0', '173', '78', '32', '265', '46.5', '1.159', '58', '0'),
('4', '99', '72', '17', '0', '25.6', '0.294', '28', '0'),
('8', '194', '80', '0', '0', '26.1', '0.551', '67', '0'),
('2', '83', '65', '28', '66', '36.8', '0.629', '24', '0'),
...
CREATE TABLE `doctor` (
  ...
  `chamber_address` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `visiting_time` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `patient_per_day` int(11) DEFAULT NULL,
...
INSERT INTO `doctor` (`id`, `name`, `speciality`, `hospital`, `designation`, `username`, `password`, `chamber_address`, `visiting_time`, `patient_per_day`, `fee`) VALUES
(1, 'dr. ahsan habib', 'Dept. of Dermatology', 'Apollo Hospitals Dhaka', 'asst. professor', 'ahsan', '1', 'Medinova Medical Services Ltd. , Malibagh, Dhaka', '9:00PM - 10:00PM', 3, '500'),
(4, 'Dr. Humaira Afrin', 'Dept. of Cardiology', 'Salimullah Medical College ', 'asst. professor', 'sakib6901', '1', 'United Hospital Ltd, Plot 15, Road 17, Gulshan 1, Dhaka', '10:00PM - 12:00PM', 5, '1500'),
(5, 'dr. habib', 'Dept. of Cardiology', 'popular medical college', 'asst. professor', 'sakib6900', '1', 'Health Labs Ltd., Main Br., Mirpur, Dhaka', '12:00PM - 8:00AM', 10, '1000'),
(6, 'dr salim reza', 'Dept. of Dermatology', 'dhaka medical', 'prof', 'salim', '1', 'Labaid Specialized Hospital, Main Br Dhanmondi, Dhaka', '6:00PM - 8:00PM', 5, '1000'),
(7, 'Dr. Indrajit Kumar Kundu', 'Dept. of Orthopaedic', 'Square Hospital Ltd.', 'Assistant Professor', 'kundu', '1', 'Square Hospitals Limited, Main Branch, Panthapath, Dhaka', '9:00PM - 10:00PM', 10, '1500');
...
CREATE TABLE `patient` (
  ...
  `pedigreeFunction` decimal(10,2) DEFAULT NULL,
...
INSERT INTO `patient` (`id`, `name`, `phone`, `username`, `password`, `pregnancies`, `glucose`, `bloodPressure`, `skinThickness`, `insulin`, `pedigreeFunction`, `height`, `weight`, `age`) VALUES
(1, 'sakib', '01715', 'sakib6900', '1', 2, 0, 0, 0, 0, '10.00', 0, 0, 0),
(10, 'Abdullah Al-Moi', '01715', 'sakib6901', '12', 1, 1, 1, 1, 1, '1.00', 1, 62, 1),
(11, 'sakib', '01715', 'sakib6902', '1', 4, 99, 68, 38, 18, '32.80', 413, 60, 33);
...
--
ALTER TABLE `appointment`
  ADD CONSTRAINT `appointment_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `appointment_ibfk_2` FOREIGN KEY (`doctor_id`) REFERENCES `doctor` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
