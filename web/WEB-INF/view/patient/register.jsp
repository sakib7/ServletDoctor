                                    ...
                                    <div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
                                        ...
                                        <div class="panel panel-skin">
                                            ...
                                            <div class="panel-heading">
                                                ...
                                                <h3 class="panel-title"><span class="fa fa-pencil-square-o"></span> Register <small>(Patient)</small></h3>
                                            </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-6 col-sm-6 col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="phone" required id="last_name" class="form-control input-md" data-rule="minlen:3" data-msg="Please enter at least 3 chars">
                                                                <div class="validation"></div>
                                                            </div>
                                                        </div>
                                                    </div>
