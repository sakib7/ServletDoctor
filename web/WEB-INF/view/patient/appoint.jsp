<%-- 
    Document   : appoint
    Created on : Apr 10, 2019, 8:07:04 PM
    Author     : sakib
--%>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="wow fadeInDown" data-wow-offset="0" data-wow-delay="0.1s">
                                    <h2 class="h-ultra">Melitus Detector</h2>
                                </div>
                                ...
                                <div class="well well-trans">
                                    <div class="wow fadeInRight" data-wow-delay="0.1s">
                                        ...
                                        <ul class="lead-list">
                                            <li><span class="fa fa-check fa-2x icon-success"></span> <span class="list"><strong>User Registration</strong><br />user can register as a patient</span></li>
                                            <li><span class="fa fa-check fa-2x icon-success"></span> <span class="list"><strong>Report statistics</strong><br />Statistics about similar patients upon analysing available profiles. </span></li>
                                            <li><span class="fa fa-check fa-2x icon-success"></span> <span class="list"><strong>Recommendation System</strong><br />Suggest desired improvements based on patient profile </span></li>
                                            <li><span class="fa fa-check fa-2x icon-success"></span> <span class="list"><strong>Appointment</strong><br />Apply for Doctor appointment </span></li>
                                        </ul>
                                    </div>
                                </div>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <form action="" method="post" role="form" class="contactForm lead">
                                                    <div class="person-text rel text-light">
                                                        ...
                                                        <a title="" href="#">
                                                            <font color="Black"><%= doctor.getName() %></font>
                                                        </a>
                                                        <span><font color="Black"><%= doctor.getSpeciality()%></font></span>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                                            <div class="form-group">
                                                                <label>Hospital</label>
                                                                <input value="<%= doctor.getHospital()%>" type="text" name="hos" id="hos" class="form-control input-md" data-rule="minlen:3" data-msg="Please enter at least 3 chars" readonly>
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                                            <div class="form-group">
                                                                <label>Address</label>
                                                                <input value="<%= doctor.getChamberAddress()%>" type="text" name="address" id="address" class="form-control input-md" data-rule="minlen:3" data-msg="Please enter at least 3 chars" readonly>
                                                                <div class="validation"></div>
                                                            </div>
                                                        </div>
                                                        <div class="col-xs-6 col-sm-6 col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input value="<%= doctor.getVisitingTime()%>" type="text" name="address" id="address" class="form-control input-md" data-rule="minlen:3" data-msg="Please enter at least 3 chars" readonly>
                                                                <div class="validation"></div>
                                                            </div>
                                                        </div>
                                                        <div class="col-xs-6 col-sm-6 col-md-6">
                                                            <div class="form-group">
                                                                <label>Fees</label>
                                                                <input value="<%= doctor.getFee() %>" type="text" name="address" id="address" class="form-control input-md" data-rule="minlen:3" data-msg="Please enter at least 3 chars" readonly>
                                                                <div class="validation"></div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
                                        ...
                                        <div class="panel panel-skin">
                                            <div class="panel-heading">
                                                ...
                                                <h3 class="panel-title"><span class="fa fa-pencil-square-o"></span> Patient Information</h3>
                                            </div>
                                            <div class="panel-body">
                                                <div id="sendmessage">Your message has been sent. Thank you!</div>
                                                <div id="errormessage"></div>

                                                <form action="make-appointment" method="post" role="form" class="contactForm lead">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                                            <div class="form-group">
                                                                <label>Name</label>
                                                                <input type="text" name="name" id="hos" class="form-control input-md" data-rule="minlen:3" data-msg="Please enter at least 3 chars" >
                                                                <div class="validation"></div>
                                                            </div>
                                                        </div>
                                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="contact" id="address" class="form-control input-md" data-rule="minlen:3" data-msg="Please enter at least 3 chars" >
                                                                <div class="validation"></div>
                                                            </div>
                                                        </div>

                                                        <input type="submit" value="Confirm Appointment" class="btn btn-skin btn-block btn-lg">
