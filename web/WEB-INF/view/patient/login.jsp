<%-- 
    Document   : login
    Created on : Apr 5, 2019, 11:53:41 PM
    Author     : sakib
--%>
                                                ...
                                                <div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
                                                    ...
                                                    <div class="panel panel-skin">
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <form action="patient-login" method="post" role="form" class="contactForm lead">
                                                            ...
                                                            <p class="text-center">Don't have an account? <a class="text-info" href="patient-register"> Sign Up </a> !</p>
                                                        </div>
                                                    </div>
